...
const features = [
  ...
  "Support for PDFs, URLs, and text",
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div className="max-w-md">
            ...
            >
              Create your free account and unlock the power of AI summaries.
            </motion.p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          >
            <Button
              size="lg"
              className="w-full h-12 text-base rounded-xl transition-all duration-300"
          ...
          >
            <p className="text-sm text-muted-foreground">
              Email signup coming soon. For now, please continue with Google.
            </p>
          </motion.div>
